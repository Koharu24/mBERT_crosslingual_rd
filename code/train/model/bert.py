...
import torch
from ...joint.model.bert import LMBertModel
...
class JointBertReverseDict(nn.Module):
    def __init__(
        self, pre_name, train_word2bpes, target_word2bpes, pad_id, num_languages
    ):
        # word2bpes:
